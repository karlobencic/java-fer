...
public class UtilDemo2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Maxtermi f("+variables+"): " + Util.toProductOfMaxterms(variables, expression));
		...
		System.out.println("Maxtermi f("+variables2+"): " + Util.toProductOfMaxterms(variables2, expression));
	}
